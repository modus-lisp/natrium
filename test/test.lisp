...
(defun run-all ()
  (let ((*fails* 0) (*count* 0))
    ...
    ;; ---- HKDF (RFC 5869) ----
    (check "hkdf-sha256 case1 (rfc5869)"
           (n:hkdf-sha256 (hex->bytes "000102030405060708090a0b0c")
                          (hex->bytes "0b0b0b0b0b0b0b0b0b0b0b0b0b0b0b0b0b0b0b0b0b0b")
                          (hex->bytes "f0f1f2f3f4f5f6f7f8f9") 42)
           "3cb25f25faacd57a90434f64d0362f2a2d2d0a90cf1a5a4c5db02d56ecc4c5bf34007208d5b887185865")
    (check "hkdf-sha256 case2 long (rfc5869)"
           (n:hkdf-sha256
            (hex->bytes "606162636465666768696a6b6c6d6e6f707172737475767778797a7b7c7d7e7f808182838485868788898a8b8c8d8e8f909192939495969798999a9b9c9d9e9fa0a1a2a3a4a5a6a7a8a9aaabacadaeaf")
    ...
    (check "hkdf-sha256 case3 empty salt/info (rfc5869)"
           (n:hkdf-sha256 (hex->bytes "")
                          (hex->bytes "0b0b0b0b0b0b0b0b0b0b0b0b0b0b0b0b0b0b0b0b0b0b")
                          (hex->bytes "") 42)
           "8da4e775a563c18f715f802a063c5a31b8a11f5c5ee1879ec3454e5f3c738d2d9d201395faa4b61a96c8")
    (check "hkdf-sha512 case1 (oracle-checked)"
           (n:hkdf-sha512 (hex->bytes "000102030405060708090a0b0c")
                          (hex->bytes "0b0b0b0b0b0b0b0b0b0b0b0b0b0b0b0b0b0b0b0b0b0b")
                          (hex->bytes "f0f1f2f3f4f5f6f7f8f9") 42)
